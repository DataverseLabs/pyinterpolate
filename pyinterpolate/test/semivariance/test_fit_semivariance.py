...
def test_fit_semivariance():
    ...
    assert (model_non_weighted == 'exponential')
    assert (model_weighted == 'exponential')

def test_fit_semivariance_io():
    ...
    file_path = 'sample_data/mock_model.csv'
...
if __name__ == '__main__':
    test_fit_semivariance()
    test_fit_semivariance_io()
