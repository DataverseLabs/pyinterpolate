...
from tests.test_variogram.theoretical.consts import TheoreticalVariogramTestData
from tests.test_variogram.theoretical.consts import get_armstrong_data
