...
from tests.test_variogram.empirical.consts import get_armstrong_data, EmpiricalVariogramTestData,\
...
class TestCovariance(unittest.TestCase):
    ...
    def test_calculate_covariance_omni(self):
        ss = 1
        mr = 2
        cov = calculate_covariance(armstrong_arr, ss, mr)
    ...
    def test_calculate_covariance_SN_lag1(self):
        ss = 1
        mr = 2
        cov = calculate_covariance(armstrong_arr, ss, mr, direction=0, tolerance=0.01)
        lag1_test_value = cov[0][1]
    ...
    def test_calculate_semivariance_WE_lag1(self):
        ss = 1
        mr = 2
        cov = calculate_covariance(armstrong_arr, ss, mr, direction=90, tolerance=0.1)
        lag1_test_value = cov[0][1]
    ...
    def test_calculate_semivariance_NW_SE_lag2(self):
        ss = 1
        mr = 4
        cov = calculate_covariance(armstrong_arr, ss, mr, direction=135, tolerance=0.01)
    ...
    def test_calculate_semivariance_NE_SW_lag2(self):
        ss = 1
        mr = 3
        cov = calculate_covariance(armstrong_arr, ss, mr, direction=45, tolerance=0.01)
        lag1_test_value = cov[1][1]
