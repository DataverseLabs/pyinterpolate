...
def calculate_average_p2b_semivariance(ds: pd.DataFrame,
                                       ...
                                       distance_col: Union[Hashable, str], ) -> pd.Series:
    """
    ...
    # groupby
    gs = ds.groupby([block_x_coo_col, block_y_coo_col, neighbor_idx_col])[['custom_weights', 'gamma_weights']].sum()
